        ...
        if (isset($_POST['scope'])) {
            ...
            switch ($scope) {
                case 'add':
                        ...
                        $check_existing_query_run = mysqli_query($con,$check_existing_query);
                        if (mysqli_num_rows($check_existing_query_run)) {
                            echo "existing";
                        }else{
                ...
                case 'update':
                        ...
                        $check_existing_query = "SELECT * FROM carts WHERE prod_id='$prod_id' AND user_id='$user_id' ";
                        $check_existing_query_run = mysqli_query($con,$check_existing_query);
                        if (mysqli_num_rows($check_existing_query_run) > 0 ) {
